...
public class oef25 {
	...
	public static void main(String[] args) {
		...
		while (geslacht != 2) {
			System.out.println("Hoe lang ben je(m)");
			lengte = keyboard.nextDouble();

			System.out.println("Hoeveel weeg je(kg)");
	...
	public static int invoerControle() {
		...
		int geslacht = keyboard2.nextInt();

		while (geslacht < 0 || geslacht > 2) {
			System.out.println("Foutief geslacht, probeer het opnieuw");
			System.out.println("Geef je geslacht in (vrouw = 0, man = 1, stop = 2)");
